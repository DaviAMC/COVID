...
def write_analise(write_dict,update_date):
    ...
    html_file.write('<div style="text-align: center;"><img style="width: 432px; height: 288px;" alt="Novos casos" src="'+regfile+"NC.jpg"+'">&nbsp; <img style="width: 432px; height: 288px;" alt="Novas mortes" src="'+regfile+"NM.jpg"+'"><br></div>')
