...
def write_analise(write_dict,update_date):
    ...
    html_file.write('<br> \n')
    html_file.write('<div style="text-align: center;"><img style="width: 432px; height: 288px;" alt="Casos Acumulados" src="'+regfile+"CA.jpg"+'">&nbsp; <img style="width: 432px; height: 288px;" alt="Mortes Acumuladas" src="'+regfile+"MA.jpg"+'"><br></div>')
