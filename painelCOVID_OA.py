...
def write_analise(write_dict,update_date):
    ...
    html_file.write('<br> \n')
    html_file.write('<div style="text-align: center;"><img style="width: 432px; height: 288px;" alt="Casos Acumulados" src="'+regfile+"CA.jpg"+'">&nbsp; <img style="width: 432px; height: 288px;" alt="Mortes Acumuladas" src="'+regfile+"OA.jpg"+'"><br></div>')
    html_file.write('<div style="text-align: center;"><img style="width: 432px; height: 288px;" alt="Novos casos" src="'+regfile+"NC.jpg"+'">&nbsp; <img style="width: 432px; height: 288px;" alt="Casos e mortes por milhao" src="'+regfile+"pm.jpg"+'"><br></div>')
    html_file.write('<div style="text-align: center;"><img style="width: 432px; height: 288px;" alt="Previsão novos casos" src="'+regfile+"PR.jpg"+'">&nbsp; <img style="width: 432px; height: 288px;" alt="Casos por semana" src="'+regfile+"CAS.jpg"+'"><br></div>')
    html_file.write('<div style="text-align: center;"><img style="width: 432px; height: 288px;" alt="mu" src="'+regfile+"MS.jpg"+'">&nbsp; <img style="width: 432px; height: 288px;" alt="r0 - dif" src="'+regfile+"R0dif.jpg"+'"><br></div>')
    html_file.write('<div style="text-align: center;"><img style="width: 432px; height: 288px;" alt="R) - int" src="'+regfile+"R0int.jpg"+'">&nbsp; <img style="width: 432px; height: 288px;" alt="mu" src="'+regfile+"mu.jpg"+'"><br></div>')
    html_file.write('<br> \n')
    html_file.write('<br> \n')
...
def drawOA(D_raw,reg,regfile,date):
...
#
    ...
    plt.savefig(regfile+"OA.jpg",bbox_inches="tight")
